<?php
    ...
    function UpdateXML($array, $xmlPath, $ftp_server, $ftp_user_name, $ftp_user_pass){
        ...
        $str = "<?xml version='1.0' encoding='utf-8'?><table border='1' style='border-collapse:collapse; text-transform: capitalize;' DateTime='".$date."'><tr><th>ID:</th><th>Name:</th><th>Organization:</th><th>Payment:</th><th>State duty payment:</th><th>Has electronic view :</th></tr>";
